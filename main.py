...
# Plotting
fig, ax = plt.subplots(figsize=(12, 6), facecolor='#f1f1f1')
...
ax.set_facecolor('#f1f1f1')  # Set the background color to black
st.pyplot(fig)
...
fig, ax = plt.subplots(figsize=(6, 0.5), facecolor='#f1f1f1')
